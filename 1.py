...
def main():
    ...
    idxes = eval(sys.argv[5])

    points1, points2 = get_sift_correspondences(img1, img2, idxes)
    ...
    rep_err, err = Problem(
        points1, points2, gt_points1, gt_points2, normalized)

    print(f"rep_err = {rep_err}")
    print(f"err = {err}")
